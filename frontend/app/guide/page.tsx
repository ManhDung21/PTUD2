  ...
  return (
    <div className="app-container">
      ...
      <div className="section">
        <div className="card" style={{ background: "linear-gradient(135deg, rgba(255,140,66,0.12), rgba(78,205,196,0.15))" }}>
          ...
          <div className="card">
            ...
            <ul style={listStyle}>
              {MOBILE_STEPS.map((item, index) => (
                <li key={item} style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                  <span style={{ ...badgeStyle, background: "rgba(78,205,196,0.2)", color: "var(--accent-lime)" }}>
                    {index + 1}
                  </span>
                  <p style={{ margin: 0, color: "var(--text-primary)", lineHeight: 1.6 }}>{item}</p>
                </li>
        ...
        <div className="card" style={{ padding: 28 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {FAQs.map((faq) => (
              ...
              >
                <summary style={{ fontWeight: 600, color: "var(--text-primary)", fontSize: 16 }}>
                  {faq.question}
                </summary>
      ...
      <div
        ...
        style={{
          marginTop: 32,
          background: "linear-gradient(135deg, rgba(255,107,107,0.18), rgba(255,140,66,0.22))",
          border: "1px solid rgba(255,255,255,0.6)",
          display: "flex",
          flexDirection: "column",
          gap: 12,
      ...
      >
        ...
        <p style={{ color: "var(--text-secondary)", margin: 0 }}>
          Liên hệ đội ngũ hỗ trợ qua email <strong>support@mdung21.id.vn</strong> hoặc gửi phản hồi ngay trong ứng dụng.
        </p>
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
          ...
          <a
            className="secondary-button"
            href="mailto:support@mdung21.id.vn"
