    ...
    <div className={isDarkMode ? "dark" : ""}>
      <div className="relative h-[100dvh] w-full overflow-hidden text-app-text flex bg-app transition-colors duration-300">
        ...
        <main className="flex-1 flex flex-col relative w-full h-full z-10 transition-all duration-300">
          ...
          {!sidebarOpen && (
            <div className="shrink-0 w-full sticky top-0 z-[100] flex items-center gap-3 px-4 py-3 bg-panel border-b border-panel-border shadow-sm md:fixed md:top-4 md:left-4 md:w-auto md:bg-transparent md:border-none md:shadow-none md:p-0 transition-all duration-300">
              <button
